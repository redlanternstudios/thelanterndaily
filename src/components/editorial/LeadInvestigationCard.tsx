      ...
      <div className="mt-8 flex flex-wrap items-center justify-between gap-4 border-t border-[#1A1F2E] pt-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            type="button"
            onClick={handleShare}
            className="inline-flex min-h-[44px] items-center gap-1.5 border border-[#1E2028] px-4 py-2 font-mono text-xs text-[#9CA3AF] transition-all hover:border-[#2A2D35] hover:text-[#F7F2EE]"
